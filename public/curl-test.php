...
// var_dump($outputObj);
// echo $outputObj->wx_desc;
// echo $outputObj->temp_f;
// echo $outputObj->feelslike_f;
// echo $outputObj->humid_pct;
// echo $outputObj->windspd_mph;
// echo $outputObj->winddir_compass;
// echo $outputObj->dewpoint_f;
